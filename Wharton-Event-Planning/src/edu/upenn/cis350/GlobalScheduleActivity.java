...
public class GlobalScheduleActivity extends Activity {
	...
	// display all events for a given conference
	public void showEvents() {
        ...
        for (int i =0; i < EVENT_TITLE.length; i++){											// Now add rows [Note: String name : NAMES]
        	...
        	addEventButton.setOnClickListener(new EventInfoListener(EVENT_TITLE[i], TIME[i], LOCATION[i], this));	// Private Class Listen for Custom OnClick listener that passes all info and context for messaging
